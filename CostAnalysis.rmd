...
printt <- function(Tab,Cap) {
  print(xtable(Tab,Cap),type='html')
}
...
IHMelt <- melt(IH[,c("Serial","Group",paste("Care_At",levels(OutPat$Facility),sep="_"))],id=c("Serial","Group"))
p <- ggplot(data=subset(IHMelt,value))
p + geom_bar(aes(x=variable,fill=Group))
